...
- Windows ChatGPT 桌面应用中的 Codex / PowerShell / CMD：C:\Users\我的用户名\.codex\config.toml
...
| 运行环境 | 配置文件位置 |
| --- | --- |
| Windows ChatGPT 桌面应用中的 Codex / PowerShell / CMD | `C:\Users\你的用户名\.codex\config.toml` |
| macOS / Linux / WSL | `~/.codex/config.toml` |
