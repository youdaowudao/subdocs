...
这里放通用接入说明、接口能力说明和进阶工具说明。  
如果你要配置某个具体客户端，请先看 [客户端接入](/clients/)。

## 页面怎么选

| 你要做什么 | 建议看 |
| --- | --- |
| 不确定 Base URL、协议或 `/v1` 怎么填 | [外接兼容与 Base URL 说明](/external/base-url) |
| 想理解 Responses 和普通兼容模式 | [Responses 与兼容模式说明](/external/compatibility) |
| 排查 User-Agent、请求头或外接识别问题 | [外接调用 User-Agent 说明](/external/user-agent) |
| 自己写脚本调用图片生成 | [生图 API](/external/image-generation) |
