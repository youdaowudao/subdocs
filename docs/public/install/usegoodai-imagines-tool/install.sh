...
release_revision="V0.7.2"
release_base="https://docs.usegoodai.com/install/usegoodai-imagines-tool/releases/v0.7.2"
...
case "$system_name/$machine_name" in
  Darwin/arm64)
    artifact="usegoodai-imagines-tool-v0.7.2-darwin-arm64"
    expected_sha256="87a738ee5f9fc37c9dc46019ad8f868706d6efe6f1bc5a87f599342c22990f79"
    ;;
  *)
    echo "安装失败：V0.7.2 仅支持 Apple Silicon 64 位 Mac，当前为 $system_name/$machine_name。" >&2
    exit 1
    ;;
esac
