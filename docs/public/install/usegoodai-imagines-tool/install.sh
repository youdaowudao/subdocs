...
release_revision="V0.7.1"
release_base="https://docs.usegoodai.com/install/usegoodai-imagines-tool/releases/v0.7.1"
...
case "$system_name/$machine_name" in
  Darwin/arm64)
    artifact="usegoodai-imagines-tool-v0.7.1-darwin-arm64"
    expected_sha256="f82bc8839c2de5969fb57d94bee7bafac99d71b286d64cf22dbbe57c6be1fea7"
    ;;
  *)
    echo "安装失败：V0.7.1 仅支持 Apple Silicon 64 位 Mac，当前为 $system_name/$machine_name。" >&2
    exit 1
    ;;
esac
