...
$ReleaseRevision = "V0.7.3"
$ReleaseBase = "https://docs.usegoodai.com/install/usegoodai-imagines-tool/releases/v0.7.3"
...
if ($NeedsDownload) {
    try {
        ...
        Download-WithPercent -Uri "$ReleaseBase/$Artifact" -Destination $BinaryPath -Activity "正在下载中转站生图工具 V0.7.3"
